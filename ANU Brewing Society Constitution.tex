...
\begin{enumerate}[label=\textbf{\arabic*}]
    ...
    \begin{enumerate}[label=4.\arabic*]
        ...
        % \item To be considered for election to the executive a member must have been involved with at least two brews with the club, there is an exception for the first year of club elections. // Removed as part of the 2022.03.11 AGM
